-- 1. Campos de relacionamento na tabela de atividades de Obras
...
-- 2. Campos de relacionamento na tabela de atividades de Construtoras
...
-- 3. Tabela de atividades de Contatos (Pessoas)
...
-- Índices para as novas colunas de relacionamento (busca cruzada rápida)
...
-- RLS no MESMO padrão das outras tabelas (público, USING true)
